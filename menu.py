...
class Menu:
    ...
    def update(self):
        ...
        if ui.button(self.surface, center_x_of_start, 920, "Start", click_sound=self.click_sound):
            return "game"
        if ui.button(self.surface, center_x_of_start+BUTTONS_SIZES[1]*3, 920, "Quit", click_sound=self.click_sound):
            pygame.quit()
            sys.exit()
